# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 12:50:43 2020
...
books =  pd.read_csv("C:\\Users\\SHRAVANI PRAJIL\\Desktop\\EXCELR\\ASSIGNMENTS\\assocoation rules\\book.csv")
books.head()
...
# Building the model for support = 0.07  and confidence = 1    ######################################
...
#rules.shape
#print(rules.head()) 
##################       number of rules are 55 for support = 0.07  and confidence =1      ########################
################## as confidence is reduced from 1 to 0.7  number rules are increased  to 55     ########
################## as confidence is reduced from 1 to 0.5  number rules are increased to 133     ########

####################### sorting books   ########################################################
#from collections import Counter
#all_books_list = []
#all_books_list = [i for item in books for i in item]
#from collections import Counter
