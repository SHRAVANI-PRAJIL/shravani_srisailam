...
#Importing Data
ccard = pd.read_csv("C:\\Users\\307009093\\Desktop\\ss\\creditcard.csv")
ccard.head()
ccard.isnull().sum()
# no null in the data
ccard.dtypes
...
data.columns  #expendditure column is eliminated
...
accuracy = (287+986)/(287+986+10+37) 
accuracy  # 96.43
# ROC curve 
...
accuracy_train = (197+706)/(197+706+1+19) # after feature selction 97.83
accuracy_train
...
accuracy_test = (97+293)/(97+293+1+5) #  after feature selction 98.48
accuracy_test
